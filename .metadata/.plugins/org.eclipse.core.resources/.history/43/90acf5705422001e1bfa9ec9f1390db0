	...
	<div class="row">
		...
		<div class="span9">
			<div class="well np">
				...
				<!--<div class="item">
							<img style="width: 100%"
								src="<c:url value ="assets/user/img/slide/bootstrap_free-ecommerce.png"/>"
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
				...
				<!--<div class="item">
							<img style="width: 100%" src="<c:url value ="assets/user/img/slide/carousel1.png"/>"
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
				...
				<!--<div class="item">
							<img style="width: 100%" src="<c:url value ="assets/user/img/slide/bootstrap-templates.png"/>"
